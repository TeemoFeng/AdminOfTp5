...
CREATE TABLE `clt_bonus_ext_set` (
  ...
  `outer_disc_trans_ratio` float(5,2) NOT NULL DEFAULT '10.00' COMMENT '外盘交易扣除手续费',
  ...
  `waller_excract_multiple` int(8) NOT NULL DEFAULT '2000' COMMENT '交易钱包提现倍数',
  PRIMARY KEY (`id`)
...
CREATE TABLE `clt_users` (
  ...
  `weixni_img_code` varchar(100) DEFAULT '' COMMENT '微信收款码',
...
-- ----------------------------
INSERT INTO `clt_users` VALUES ('1', '', '123@qq.com', '2030486a0b68d6a0c7252fc448503de8', '123456', null, '1', '0', '1552320022', '0', '0', '', '', '44311', '0', '', null, null, '/uploads/20180613/fcb729987d8e9339bd9b2e85c85f3028.jpg', '19', '259', '2599', '0', '', 'chichu', '1', '0', '', '不要应为走得太远，就忘了当初为什么出发！', '0', '', '0.00', '0.00', '0.00', '', '', '', '', '3', '11111', '1100220033004400', '法国恢复刚刚恢复', '', '', '0', '0', '1', '2019-03-12', '0', '', '0', '0');
...
-- ----------------------------
INSERT INTO `clt_user_apply_trade_cash` VALUES ('1', '7', '5.0000', '45.00', '40.00', '5.00', '1', '1553836510', '1', '1', '');
INSERT INTO `clt_user_apply_trade_cash` VALUES ('2', '7', '10.0000', '70.00', '65.00', '5.00', '1', '1553836510', '1', '1', '');
...
CREATE TABLE `clt_user_currency_account` (
  ...
  `transaction_num` decimal(14,4) DEFAULT '0.0000' COMMENT '交易钱包余额',
...
INSERT INTO `clt_user_currency_account` VALUES ('2', '7', '20.0000', '0.0000', '0.0000', '30.0000', '0.0000', '0.0000', '7.00');
