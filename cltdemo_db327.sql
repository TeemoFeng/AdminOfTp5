...
CREATE TABLE `clt_currency_list` (
  ...
  `status` tinyint(2) NOT NULL DEFAULT '0' COMMENT '上线状态0未上线，1已上线',
  `trade_status` tinyint(2) NOT NULL DEFAULT '0' COMMENT '交易状态0未开启，1已开启',
  `draw_num` int(7) DEFAULT '0' COMMENT '单次最大提取额度',
  `num` decimal(10,4) DEFAULT '0.0000' COMMENT '发行总量',
  `en_name` varchar(10) DEFAULT '' COMMENT '英文标识',
  `virtual_trans` decimal(10,4) DEFAULT '0.0000' COMMENT '虚拟成交量',
  `virtual_trans_num` decimal(10,4) DEFAULT '0.0000' COMMENT '24h虚拟成交额',
...
-- ----------------------------
INSERT INTO `clt_system` VALUES ('1', 'YWFPHP', 'http://cltshow.test/', 'CLTPHP', 'CLTPHP,CLTPHP内容管理系统,php', 'CLTPHP内容管理系统，微信公众平台、APP移动应用设计、HTML5网站API定制开发。大型企业网站、个人博客论坛、手机网站定制开发。更高效、更快捷的进行定制开发。', '陕ICP备15008093号-3', '2015-2020', '西安市雁塔区', '18792402229', '1109305987@qq.com', '/uploads/20180608/55624159eb051a6c5e9bfadff49bf731.png', 'open', 'open');
