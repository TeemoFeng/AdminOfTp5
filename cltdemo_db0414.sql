...
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='后台管理员';

-- ----------------------------
-- Records of clt_admin
-- ----------------------------
INSERT INTO `clt_admin` VALUES ('1', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '1', '1109305987@qq.com', '', '18792402229', '127.0.0.1', '1482132862', '0', '1', '/uploads/20180625/f266169c2956429d9aaea6cf6f1e51cb.jpg');
INSERT INTO `clt_admin` VALUES ('11', 'ywf', 'e10adc3949ba59abbe56e057f20f883e', '2', '97633852@qq.com', null, '15011555845', '127.0.0.1', '1542951328', '0', '1', '/uploads/20181123/fb106ec10207002ac5389aef137e7fc6.png');
INSERT INTO `clt_admin` VALUES ('12', 'sdf', '1aabac6d068eef6a7bad3fdf50a05cc8', '1', '123456@qq.com', null, '11111111111', '127.0.0.1', '1546516388', '0', '0', '');
INSERT INTO `clt_admin` VALUES ('13', 'ywf01', 'e10adc3949ba59abbe56e057f20f883e', '2', '97633852@qq.com', null, '15011555845', '127.0.0.1', '1546587021', '0', '0', '');
...
INSERT INTO `clt_article` VALUES ('25', '5', '1', 'admin', 'CLTPHP手册更新自定义标签', 'CLTPHP手册更新自定义标签', 'CLTPHP手册更新自定义标签', '<p>CLTPHP手册更新自定义标签，文档详细讲述了 {clt:list}{/clt:list} 和 {clt:info}{/clt:info} 两个标签的参数和调用方法。</p>', '0', '1', '1', '0', '', '0', '0', '1098', '1503365502', '0', 'CLTPHP', 'http://www.cltphp.com/', '', '');
...
INSERT INTO `clt_auth_group` VALUES ('2', '管理员', '1', '0,1,2,270,15,16,145,17,181,18,111,3,5,127,128,4,129,189,190,239,241,242,7,9,14,13,27,29,161,163,164,162,38,167,182,169,166,28,48,31,32,45,170,171,175,174,173,46,176,183,179,178,196,197,202,252,203,205,204,257,272,206,207,212,208,260,267,269,', '1465114224');
...
CREATE TABLE `clt_auth_rule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=311 DEFAULT CHARSET=utf8 COMMENT='权限节点';
...
INSERT INTO `clt_auth_rule` VALUES ('189', 'Module', '模型管理', '1', '1', '0', 'icon-ungroup', '', '0', '50', '1466825363', '0', '0');
...
INSERT INTO `clt_auth_rule` VALUES ('282', 'Finance/convert', '动态奖转阿美币列表', '1', '1', '1', '', '', '281', '0', '1552312629', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('283', 'Finance/lockPosition', '转账锁仓列表', '1', '1', '1', '', '', '281', '7', '1552312726', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('284', 'Finance/bonusStatistics', '奖金统计', '1', '1', '1', '', '', '281', '6', '1552312796', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('285', 'Finance/allocationRatio', '公司拨比', '1', '1', '1', '', '', '281', '5', '1552313039', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('286', 'Finance/financialFlow', '财务流水', '1', '1', '1', '', '', '281', '4', '1552313118', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('287', 'Finance/currencyRecharge', '货币充值', '1', '1', '1', '', '', '281', '1', '1552313240', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('288', 'Finance/currencyDeduction', '货币扣除', '1', '1', '1', '', '', '281', '1', '1552313311', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('289', 'Finance/applicationRecharge', '申请充值列表', '1', '1', '1', '', '', '281', '2', '1552313417', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('290', 'Finance/applicationForCash', '申请提现列表', '1', '1', '1', '', '', '281', '3', '1552313492', null, '1');
...
INSERT INTO `clt_auth_rule` VALUES ('307', 'Users/noActiceList', '未激活列表', '1', '1', '1', '', '', '27', '3', '1554280537', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('308', 'Messages', '消息中心', '1', '1', '1', 'icon-bubbles3', '', '0', '50', '1554468543', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('309', 'Messages/messageList', '消息列表', '1', '1', '1', '', '', '308', '1', '1554468577', null, '1');
INSERT INTO `clt_auth_rule` VALUES ('310', 'Messages/publish', '发布信息', '1', '1', '1', '', '', '308', '2', '1554472448', null, '1');

-- ----------------------------
-- Table structure for clt_bank
-- ----------------------------
DROP TABLE IF EXISTS `clt_bank`;
CREATE TABLE `clt_bank` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `bank_name` varchar(50) NOT NULL DEFAULT '' COMMENT '银行名字',
  PRIMARY KEY (`id`)
...
-- Records of clt_bank
-- ----------------------------
INSERT INTO `clt_bank` VALUES ('1', '中国工商银行');
INSERT INTO `clt_bank` VALUES ('2', '中国农业银行');
INSERT INTO `clt_bank` VALUES ('3', '中国银行');
INSERT INTO `clt_bank` VALUES ('4', '招商银行');
INSERT INTO `clt_bank` VALUES ('5', '中兴银行');
INSERT INTO `clt_bank` VALUES ('6', '交通银行');
INSERT INTO `clt_bank` VALUES ('7', '深圳发展银行');
INSERT INTO `clt_bank` VALUES ('8', '中国建设银行');
INSERT INTO `clt_bank` VALUES ('9', '兴业银行');
INSERT INTO `clt_bank` VALUES ('10', '中国光大银行');

-- ----------------------------
-- Table structure for clt_bonus_ext_set
-- ----------------------------
DROP TABLE IF EXISTS `clt_bonus_ext_set`;
CREATE TABLE `clt_bonus_ext_set` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `shate_ratio` int(3) NOT NULL DEFAULT '0' COMMENT '奖金进入沙特连比率',
  `amei_ratio` int(3) NOT NULL DEFAULT '0' COMMENT '奖金进入阿美币比率',
  `baodan_num` smallint(3) NOT NULL COMMENT '报单几个F4会员升级为报单中心',
  `baodan_ratio` float(4,0) NOT NULL DEFAULT '1' COMMENT '每报一单奖励比率',
  `lock_time` tinyint(3) NOT NULL DEFAULT '0' COMMENT '外系统兑换锁仓时间',
  `day_top_ratio` int(3) NOT NULL DEFAULT '50' COMMENT '奖金每日封顶比率',
  `extract_num` int(5) NOT NULL DEFAULT '10' COMMENT '每次提取币种数量',
  `extract_deduction_ratio` float(5,2) NOT NULL DEFAULT '10.00' COMMENT '币种提现手续费比率',
  `double_throw_num` int(5) NOT NULL DEFAULT '10' COMMENT '复投数量设置',
  `day_extract_num` int(3) NOT NULL DEFAULT '1' COMMENT '每天可提取次数',
  `double_throw_recall` float(3,2) NOT NULL DEFAULT '5.00' COMMENT '复投撤回手续费比率',
  `principal_recall` float(3,2) NOT NULL DEFAULT '5.00' COMMENT '本金撤资时需要扣除的手续费',
  `money_change` float(5,2) NOT NULL DEFAULT '7.00' COMMENT '兑换美元比率',
  `outer_disc_trans_ratio` float(5,2) NOT NULL DEFAULT '10.00' COMMENT '交易账户提现扣除手续费',
  `outer_disc_trans_to_waller` float(5,2) NOT NULL DEFAULT '20.00' COMMENT '外盘交易给消费钱包的比率',
  `trans_ratio` float(5,2) NOT NULL DEFAULT '0.10' COMMENT '交易双方扣除手续费',
  `waller_excract_ratio` int(8) NOT NULL DEFAULT '2000' COMMENT '消费钱包最小提现',
  `waller_excract_multiple` int(8) NOT NULL DEFAULT '2000' COMMENT '消费钱包提现倍数',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_bonus_ext_set
-- ----------------------------
INSERT INTO `clt_bonus_ext_set` VALUES ('1', '50', '50', '1', '1', '12', '50', '10', '10.00', '10', '1', '5.00', '5.00', '7.00', '10.00', '20.00', '0.10', '2000', '2000');

-- ----------------------------
-- Table structure for clt_bonus_set
-- ----------------------------
DROP TABLE IF EXISTS `clt_bonus_set`;
CREATE TABLE `clt_bonus_set` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'user_id的id',
  `declaration` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '报单额',
  `static_gains` float(5,2) NOT NULL DEFAULT '0.13' COMMENT '静态收益',
  `bonus_ratio` float(5,2) NOT NULL DEFAULT '1.00' COMMENT '直推奖比例',
  `level_id` int(3) DEFAULT '0' COMMENT 'user_level的id',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_bonus_set
-- ----------------------------
INSERT INTO `clt_bonus_set` VALUES ('1', '100.00', '0.13', '1.00', '1');
INSERT INTO `clt_bonus_set` VALUES ('2', '500.00', '0.15', '1.50', '2');
INSERT INTO `clt_bonus_set` VALUES ('3', '1000.00', '0.16', '2.00', '3');
INSERT INTO `clt_bonus_set` VALUES ('4', '5000.00', '0.18', '2.50', '4');
INSERT INTO `clt_bonus_set` VALUES ('5', '10000.00', '0.20', '3.00', '5');

-- ----------------------------
-- Table structure for clt_bonus_type
-- ----------------------------
DROP TABLE IF EXISTS `clt_bonus_type`;
CREATE TABLE `clt_bonus_type` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL DEFAULT '' COMMENT '奖金类型',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_bonus_type
-- ----------------------------
INSERT INTO `clt_bonus_type` VALUES ('1', '投资分红');
INSERT INTO `clt_bonus_type` VALUES ('2', '分享红包');
INSERT INTO `clt_bonus_type` VALUES ('3', '推广红包');
INSERT INTO `clt_bonus_type` VALUES ('4', '激活红包');
...
-- ----------------------------
INSERT INTO `clt_category` VALUES ('1', '最新动态', 'news', '', '0', '2', 'article', '0', '1,5,6', '0', '最新动态', '最新动态', '最新动态', '4', '0', '1', '0', '', '1', '', 'article-list', 'article-show', '0', '1,2,3', '0', '0', '0');
INSERT INTO `clt_category` VALUES ('2', '关于我们', 'about', '', '0', '1', 'page', '0', '2', '0', '关于我们', 'CLTPHP内容管理系统，微信公众平台、APP移动应用设计、HTML5网站API定制开发。大型企业网站、个人博客论坛、手机网站定制开发。更高效、更快捷的进行定制开发。', 'CLTPHP内容管理系统，微信公众平台、APP移动应用设计、HTML5网站API定制开发。大型企业网站、个人博客论坛、手机网站定制开发。更高效、更快捷的进行定制开发。', '0', '0', '1', '0', '', '0', '', '', '', '0', '', '0', '0', '0');
INSERT INTO `clt_category` VALUES ('4', '系统操作', 'system', '', '0', '3', 'picture', '0', '4', '0', 'CLTPHP系统操作', 'CLTPHP系统操作,CLTPHP,CLTPHP内容管理系统', 'CLTPHP系统操作,CLTPHP,CLTPHP内容管理系统', '2', '0', '1', '0', '', '0', '', '', '', '0', '1,2,3', '0', '0', '0');
...
INSERT INTO `clt_category` VALUES ('8', '联系我们', 'contact', '', '0', '1', 'page', '0', '8', '0', '联系我们', '联系我们', '联系我们', '7', '0', '1', '0', '', '0', '', 'page_show_contace', 'page_show_contace', '0', '', '0', '0', '0');
INSERT INTO `clt_category` VALUES ('7', '精英团队', 'team', '', '0', '6', 'team', '0', '7', '0', '精英团队', '精英团队', '精英团队', '5', '0', '1', '0', '', '0', '', '', '', '0', '', '0', '0', '0');
INSERT INTO `clt_category` VALUES ('5', 'CLTPHP动态', 'news2', 'news/', '1', '2', 'article', '0,1', '5', '0', 'CLTPHP动态', 'CLTPHP动态', 'CLTPHP动态', '0', '0', '1', '0', '', '0', '', '', '', '5', '1,2,3', '0', '0', '1');
INSERT INTO `clt_category` VALUES ('6', '相关知识 ', 'news', 'news/', '1', '2', 'article', '0,1', '6', '0', 'CLTPHP相关知识', 'CLTPHP相关知识', 'CLTPHP相关知识', '0', '0', '1', '0', '', '0', '', '', '', '0', '', '0', '0', '1');
INSERT INTO `clt_category` VALUES ('14', '文件下载', 'download', '', '0', '5', 'download', '0', '14', '0', '测试下载', '测试下载', '测试下载', '0', '0', '1', '0', '', '0', '', '', '', '10', '1,2', '0', '0', '0');

-- ----------------------------
-- Table structure for clt_company_day_running
-- ----------------------------
DROP TABLE IF EXISTS `clt_company_day_running`;
CREATE TABLE `clt_company_day_running` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `income` decimal(14,4) DEFAULT '0.0000' COMMENT '收入',
  `expenses` decimal(14,4) DEFAULT '0.0000' COMMENT '支出',
  `time` date DEFAULT '0000-00-00' COMMENT '当天时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_company_day_running
-- ----------------------------
INSERT INTO `clt_company_day_running` VALUES ('1', '1000.0000', '500.0000', '2019-03-28');
INSERT INTO `clt_company_day_running` VALUES ('2', '2000.0000', '500.0000', '2019-03-29');
...
INSERT INTO `clt_config` VALUES ('63', 'smtp_pwd', 'zmmqivflahemiegc', 'smtp', '0');
...
-- ----------------------------
-- Table structure for clt_currency
-- ----------------------------
DROP TABLE IF EXISTS `clt_currency`;
CREATE TABLE `clt_currency` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(30) NOT NULL DEFAULT '' COMMENT '币种名称',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_currency
-- ----------------------------
INSERT INTO `clt_currency` VALUES ('1', '沙特链');
INSERT INTO `clt_currency` VALUES ('2', '激活钱包');
INSERT INTO `clt_currency` VALUES ('3', '消费钱包');
INSERT INTO `clt_currency` VALUES ('4', '交易账号');
INSERT INTO `clt_currency` VALUES ('5', '本金账户');

-- ----------------------------
-- Table structure for clt_currency_list
-- ----------------------------
DROP TABLE IF EXISTS `clt_currency_list`;
CREATE TABLE `clt_currency_list` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(40) NOT NULL DEFAULT '' COMMENT '币种名称',
  `logo` varchar(255) DEFAULT '' COMMENT '货币logo',
  `status` varchar(10) NOT NULL DEFAULT 'close' COMMENT '上线状态close不允许，open允许，',
  `trade_status` varchar(10) NOT NULL DEFAULT 'close' COMMENT '交易状态close不允许，open允许，',
  `withdraw_status` varchar(10) NOT NULL DEFAULT 'close' COMMENT '提币状态，close不允许，open允许，',
  `draw_num` int(7) DEFAULT '0' COMMENT '单次最大提取额度',
  `num` decimal(14,4) DEFAULT '0.0000' COMMENT '发行总量',
  `en_name` varchar(10) DEFAULT '' COMMENT '英文标识',
  `user_name` varchar(70) DEFAULT '' COMMENT '用户名',
  `pas` varchar(50) DEFAULT '' COMMENT '密码',
  `url` varchar(255) DEFAULT '' COMMENT '地址端口号',
  `port` varchar(10) DEFAULT '' COMMENT '端口号',
  `detail_link` varchar(255) DEFAULT '' COMMENT '货币详情链接',
  `abs_fee` decimal(10,4) DEFAULT '0.0000' COMMENT '提币旷工费',
  `virtual_trans` decimal(14,4) DEFAULT '0.0000' COMMENT '虚拟成交量',
  `virtual_trans_num` decimal(16,4) DEFAULT '0.0000' COMMENT '24h虚拟成交额',
  `create_time` datetime DEFAULT '0000-00-00 00:00:00' COMMENT '创建时间',
  `price` decimal(14,4) DEFAULT '0.0000' COMMENT '价格(测试用）',
  `update_time` datetime DEFAULT '0000-00-00 00:00:00' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_currency_list
-- ----------------------------
INSERT INTO `clt_currency_list` VALUES ('7', '阿美币', '', 'open', 'close', 'close', '1000', '200000000.0000', 'AMB', '', '', '', '', '', '2.0000', '100000.0000', '100000.0000', '2019-04-02 14:47:48', '2.0000', '2019-04-02 14:47:48');
INSERT INTO `clt_currency_list` VALUES ('3', '最火的币', '', 'open', 'open', 'close', '4454', '3445346456.0000', 'hot2', '', '', '', '', '', '8.0000', '325434534.0000', '23421534534.0000', '2019-03-27 14:01:45', '5.0000', '2019-03-27 14:01:45');
INSERT INTO `clt_currency_list` VALUES ('4', '比特币', '', 'open', 'close', 'close', '10', '10000.0000', 'BTC', '', '', '', '', '', '2.0000', '10000.0000', '232340000.0000', '2019-04-02 13:34:31', '8.0000', '2019-04-02 13:34:31');
INSERT INTO `clt_currency_list` VALUES ('5', '莱特币', '', 'open', 'close', 'close', '324', '3432543.0000', 'LTC', '', '', '', '', '', '3.0000', '243534.0000', '234234234.0000', '2019-04-02 13:35:57', '10.0000', '2019-04-02 13:35:57');
INSERT INTO `clt_currency_list` VALUES ('6', '以太坊', '', 'open', 'open', 'close', '111', '3535343.0000', 'ETH', '', '', '', '', '', '3.0000', '3453545.0000', '234534534534.0000', '2019-04-02 13:40:57', '12.0000', '2019-04-02 13:40:57');

-- ----------------------------
-- Table structure for clt_currency_running_log
-- ----------------------------
DROP TABLE IF EXISTS `clt_currency_running_log`;
CREATE TABLE `clt_currency_running_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL DEFAULT '0' COMMENT '用户id',
  `about_id` int(10) NOT NULL DEFAULT '0' COMMENT '相关用户id',
  `running_type` int(3) DEFAULT '0' COMMENT '流水类型',
  `currency_from` int(4) DEFAULT '0',
  `currency_to` int(4) DEFAULT '0' COMMENT '币种id',
  `change_num` decimal(10,4) DEFAULT '0.0000' COMMENT '变更数量',
  `create_time` int(10) DEFAULT '0' COMMENT '流水时间',
  `remark` varchar(255) DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_currency_running_log
-- ----------------------------
INSERT INTO `clt_currency_running_log` VALUES ('1', '1', '1', '25', null, '7', '70.0000', '1554628798', '现金币转换阿美币,阿美币增加');
INSERT INTO `clt_currency_running_log` VALUES ('2', '1', '1', '25', '0', '7', '70.0000', '1554648904', '现金币转换阿美币,阿美币增加');
...
INSERT INTO `clt_feast` VALUES ('4', '七夕', '1', '50', '1532420762', '11-23', '1');
...
INSERT INTO `clt_page` VALUES ('8', '联系我们', 'color:;font-weight:normal;', '', '10', '1', '0', '', '0', '1499765407', '0', '0', '<p>您的支持是我们一往无前的无限动力，非常荣幸在<a target=\"_self\" href=\"http://www.cltphp.com/\">CLTPHP</a>成长的道路上有您的陪伴！！！</p>', '');
...
-- ----------------------------
INSERT INTO `clt_system` VALUES ('1', 'YWFPHP', 'http://cltshow.test/', 'CLTPHP', 'CLTPHP,CLTPHP内容管理系统,php', 'CLTPHP内容管理系统，微信公众平台、APP移动应用设计、HTML5网站API定制开发。大型企业网站、个人博客论坛、手机网站定制开发。更高效、更快捷的进行定制开发。', '陕ICP备15008093号-3', '2015-2020', '西安市雁塔区', '18792402229', '1109305987@qq.com', '/uploads/20180608/55624159eb051a6c5e9bfadff49bf731.png', 'close', 'open');
...
CREATE TABLE `clt_users` (
  ...
  `pwd` varchar(30) DEFAULT '' COMMENT '明文密码',
  ...
  `is_lock` tinyint(1) DEFAULT '0' COMMENT '是否被锁定冻结 1冻结',
  `token` varchar(64) DEFAULT '' COMMENT '用于app 授权类似于session_id',
  `sign` varchar(255) DEFAULT '' COMMENT '签名',
  `status` tinyint(2) DEFAULT '0' COMMENT '会员状态，0：未激活，1激活',
  ...
  `alipay_pass` varchar(30) DEFAULT '' COMMENT '支付宝安全密码',
  `weixin_pass` varchar(30) DEFAULT '',
  `weixin_account` varchar(70) DEFAULT '' COMMENT '微信账号',
  ...
  `bank_pass` varchar(30) DEFAULT '' COMMENT '银行卡安全密码',
  `bank_desc` varchar(80) NOT NULL DEFAULT '' COMMENT '开户行详细信息',
  `alipay_img_code` varchar(100) DEFAULT '' COMMENT '支付宝收款码',
  `weixin_img_code` varchar(100) DEFAULT '' COMMENT '微信收款码',
  `pid` int(10) NOT NULL DEFAULT '0' COMMENT '推荐关系id',
  ...
  `baodan_user` varchar(50) DEFAULT '' COMMENT '报单人',
...
-- ----------------------------
INSERT INTO `clt_users` VALUES ('1', '0000', '123@qq.com', '2030486a0b68d6a0c7252fc448503de8', '', '123456', null, '1', '0', '1552320022', '0', '0', '', '', '44311', '0', '', null, null, '/uploads/20190331/d49f8679c5f05670588ee3c91b56c310.png', '19', '259', '2599', '0', '公司', '公司', '0', '0', '', '不要应为走得太远，就忘了当初为什么出发！', '1', '', '0.00', '0.00', '0.00', '', '', 'yangweifeng@111.com', '123456', '', '', '1', 'test', '456783424234324234324', '123456', '的接口砥砺奋进', '/uploads/20190330/6cd2e807243439459748575f730a8ef3.png', '', '0', '0', '1', '2019-03-12', '1', '', '1', '0');
INSERT INTO `clt_users` VALUES ('16', 'uoh046890', '', 'e10adc3949ba59abbe56e057f20f883e', '', '123456', null, '0', '0', '1554357425', '1554357645', '0', '', '', '18331334453', '0', '', null, null, null, '0', '0', '0', '0', '', '第二个1', '2', '0', '', '', '1', 'mdt041074', '0.00', '0.00', '0.00', '413434234243242441', 'mdt041074', '18331334453', '', '', '', '0', '第二个1', '110033004400550011', '', '地方', '', '', '15', '15', '0', '2019-04-04', '0', 'mdt041074', '1', '1');
INSERT INTO `clt_users` VALUES ('15', 'mdt041074', '', 'e10adc3949ba59abbe56e057f20f883e', '', '123456', null, '0', '0', '1554357192', '1554357230', '0', '', '', '18331334454', '0', '', null, null, null, '0', '0', '0', '0', '', '第二个', '5', '0', '', '', '1', '0000', '0.00', '0.00', '0.00', '413434234243242442', '0000', '18331334454', '', '', '', '0', '第二个', '345435435435345345', '', '多福多寿', '', '', '1', '1', '1', '2019-04-04', '1', '0000', '1', '1');
INSERT INTO `clt_users` VALUES ('14', 'ddh044969', '', 'e10adc3949ba59abbe56e057f20f883e', '', '123456', null, '0', '0', '1554357040', '1554357239', '0', '', '', '18331334455', '0', '', null, null, null, '0', '0', '0', '0', '', '第一个', '5', '0', '', '', '1', '0000', '0.00', '0.00', '0.00', '413434234243242443', '0000', '18331334455', '', '', '', '0', '第一个', '110022003300440055', '', '水电费撒地方', '', '', '1', '1', '0', '2019-04-04', '1', '0000', '1', '1');
INSERT INTO `clt_users` VALUES ('17', 'fsq047103', '', 'e10adc3949ba59abbe56e057f20f883e', '', '123456', null, '0', '0', '1554358942', '1554358956', '0', '', '', '18331334456', '0', '', null, null, null, '0', '0', '0', '0', '', '第二个二', '2', '0', '', '', '1', 'mdt041074', '0.00', '0.00', '0.00', '413434234243242440', 'mdt041074', '18331334456', '', '', '', '0', '第二个二', '345435435435345348', '', '的非官方个', '', '', '15', '15', '0', '2019-04-04', '1', '0000', '1', '1');
INSERT INTO `clt_users` VALUES ('18', 'ouy067977', '', '2030486a0b68d6a0c7252fc448503de8', 'iSpTGPGp7gsKDrmbRcWfnfZP6lmn4f', 'a123456', null, '0', '0', '1554529602', '0', '0', '', '', '18339817892', '1', '', null, null, null, '0', '0', '0', '0', '疯疯疯', '大阿雷', '0', '0', '', '', '0', '', '0.00', '0.00', '0.00', '234353453454353545', '', '', '', '', '', '0', '', '', '', '', '', '', '0', '0', '0', '0000-00-00', '0', '', '0', '0');
...
CREATE TABLE `clt_user_apply_consume_cash` (
  ...
  `status` tinyint(2) NOT NULL DEFAULT '1' COMMENT '申请状态，1未审核，2已审核，3未通过',
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '提现时间',
  `cash_method` tinyint(3) DEFAULT '0' COMMENT '提现方式',
  `del` tinyint(2) DEFAULT '1' COMMENT '1正常，0删除',
  `reason` varchar(500) DEFAULT '' COMMENT '未通过原因',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `clt_user_apply_shate_cash` (
  ...
  `cash_num` decimal(10,4) NOT NULL DEFAULT '0.0000' COMMENT '提现数量',
  `cash_sum` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '提现金额',
  `real_sum` decimal(10,2) DEFAULT NULL COMMENT '到账金额(人民币）',
  `poundage` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '手续费',
  `status` tinyint(2) NOT NULL DEFAULT '1' COMMENT '申请状态，1未审核，2已通过，3未通过',
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '提现时间',
  `cash_method` tinyint(3) DEFAULT '0' COMMENT '提现方式',
  `del` tinyint(2) DEFAULT '1' COMMENT '0删除，1正常',
  `reason` varchar(500) DEFAULT '' COMMENT '未通过原因',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `clt_user_apply_shate_cash` VALUES ('1', '7', '2.0000', '14.00', '12.00', '2.00', '3', '1553836510', '1', '0', '无法电饭锅');
INSERT INTO `clt_user_apply_shate_cash` VALUES ('2', '7', '2.0000', '18.00', '12.00', '3.00', '1', '1553836888', '1', '0', '');
...
CREATE TABLE `clt_user_apply_trade_cash` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL DEFAULT '0' COMMENT '申请提现用户id',
  `cash_sum` decimal(14,2) NOT NULL DEFAULT '0.00' COMMENT '提现金额',
  `real_sum` decimal(14,2) DEFAULT '0.00' COMMENT '到账金额',
  `poundage` decimal(14,2) NOT NULL DEFAULT '0.00' COMMENT '手续费',
  `status` tinyint(2) NOT NULL DEFAULT '1' COMMENT '申请状态，1未审核，2已审核，3未通过',
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '提现时间',
  `cash_method` tinyint(3) DEFAULT '0' COMMENT '提现方式',
  `del` tinyint(2) DEFAULT '1' COMMENT '0删除，1正常',
...
-- ----------------------------
INSERT INTO `clt_user_apply_trade_cash` VALUES ('1', '7', '45.00', '40.00', '5.00', '1', '1553836510', '1', '1', '', '');
INSERT INTO `clt_user_apply_trade_cash` VALUES ('2', '7', '70.00', '65.00', '5.00', '1', '1553836510', '1', '1', '', '');
INSERT INTO `clt_user_apply_trade_cash` VALUES ('3', '1', '111.00', '77.70', '33.30', '1', '1554114659', '1', '1', '', '');
INSERT INTO `clt_user_apply_trade_cash` VALUES ('4', '1', '100.00', '70.00', '30.00', '1', '1554127570', '1', '1', '', '');
INSERT INTO `clt_user_apply_trade_cash` VALUES ('5', '1', '100.00', '70.00', '30.00', '1', '1554127578', '1', '1', '', '');
INSERT INTO `clt_user_apply_trade_cash` VALUES ('6', '1', '100.00', '70.00', '30.00', '1', '1554127604', '1', '1', '', '');
INSERT INTO `clt_user_apply_trade_cash` VALUES ('7', '1', '100.00', '70.00', '30.00', '1', '1554127677', '1', '1', '', '');
INSERT INTO `clt_user_apply_trade_cash` VALUES ('8', '1', '125.00', '87.50', '37.50', '1', '1554129818', '1', '1', '', '');
INSERT INTO `clt_user_apply_trade_cash` VALUES ('9', '1', '200.00', '140.00', '60.00', '2', '1554130254', '1', '1', '', '');
...
INSERT INTO `clt_user_auth_rule` VALUES ('2', 'User/userList', '会员列表', '1', '1', '0', '', '', '1', '50', '1553177811', null, '1');
...
INSERT INTO `clt_user_auth_rule` VALUES ('25', 'User/register', '新用户注册', '1', '1', '0', '', '', '1', '1', '1554278396', null, '1');
INSERT INTO `clt_user_auth_rule` VALUES ('21', 'Message/publish', '发布信息', '1', '1', '0', '', '', '17', '1', '1553581225', null, '1');
INSERT INTO `clt_user_auth_rule` VALUES ('22', 'Message/messageList', '信息列表', '1', '1', '0', '', '', '17', '2', '1553581258', null, '1');
INSERT INTO `clt_user_auth_rule` VALUES ('23', 'Bourse/index', '交易中心', '1', '1', '0', '', '', '19', '1', '1553581296', null, '1');

-- ----------------------------
-- Table structure for clt_user_bind_log
-- ----------------------------
DROP TABLE IF EXISTS `clt_user_bind_log`;
CREATE TABLE `clt_user_bind_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL DEFAULT '0' COMMENT '用户id',
  `type` tinyint(3) NOT NULL DEFAULT '0' COMMENT '安全设置类型，1实名认证，2绑定手机，3绑定邮箱，4修改手机绑定，5修改邮箱绑定,6修改密码，7修改资金密码',
  `ip` varchar(20) DEFAULT '' COMMENT 'ip地址',
  `create_time` datetime DEFAULT '0000-00-00 00:00:00' COMMENT '时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_user_bind_log
-- ----------------------------
INSERT INTO `clt_user_bind_log` VALUES ('1', '1', '6', '127.0.0.1', '2019-03-30 23:59:19');
INSERT INTO `clt_user_bind_log` VALUES ('2', '1', '6', '127.0.0.1', '2019-03-31 00:01:02');
INSERT INTO `clt_user_bind_log` VALUES ('3', '1', '6', '127.0.0.1', '2019-03-31 00:02:33');
INSERT INTO `clt_user_bind_log` VALUES ('4', '18', '7', '127.0.0.1', '2019-04-06 14:06:45');

-- ----------------------------
-- Table structure for clt_user_cancel_order_log
-- ----------------------------
DROP TABLE IF EXISTS `clt_user_cancel_order_log`;
CREATE TABLE `clt_user_cancel_order_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL DEFAULT '0' COMMENT '用户id',
  `num` tinyint(3) DEFAULT '0' COMMENT '用户撤销次数',
  `time` date DEFAULT '0000-00-00' COMMENT '时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_user_cancel_order_log
-- ----------------------------

-- ----------------------------
-- Table structure for clt_user_currency_account
-- ----------------------------
DROP TABLE IF EXISTS `clt_user_currency_account`;
CREATE TABLE `clt_user_currency_account` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL DEFAULT '0' COMMENT '用户id',
  `cash_currency_num` decimal(14,4) DEFAULT '0.0000' COMMENT '现金币数量（即产生的收益沙特链）',
  `cash_input_num` decimal(14,4) DEFAULT '0.0000' COMMENT '复投数量',
  `corpus` decimal(14,4) DEFAULT '0.0000' COMMENT '用户本金账户余额',
  `activation_num` decimal(14,4) DEFAULT '0.0000' COMMENT '激活钱包余额',
  `consume_num` decimal(14,4) DEFAULT '0.0000' COMMENT '消费钱包余额',
  `transaction_num` decimal(12,2) DEFAULT '0.00' COMMENT '交易钱包余额(人民币)',
  `rate` decimal(4,2) DEFAULT '0.00' COMMENT '用户购买时美元兑换人民币利率',
  `status` tinyint(2) DEFAULT '1' COMMENT '0账户冻结，1正常',
  `level_id` int(3) DEFAULT '0' COMMENT '用户级别',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `clt_user_currency_account` VALUES ('1', '1', '574.0000', '91.0000', '10000.0000', '0.0000', '0.0000', '2234.00', '7.00', '1', '0');
INSERT INTO `clt_user_currency_account` VALUES ('2', '7', '20.0000', '0.0000', '0.0000', '30.0000', '0.0000', '0.00', '7.00', '1', '0');
INSERT INTO `clt_user_currency_account` VALUES ('3', '3', '1.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.00', '7.00', '1', '0');
INSERT INTO `clt_user_currency_account` VALUES ('4', '0', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.00', '7.00', '1', '0');
INSERT INTO `clt_user_currency_account` VALUES ('5', '0', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.00', '7.00', '1', '0');
INSERT INTO `clt_user_currency_account` VALUES ('6', '0', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.00', '7.00', '1', '0');
INSERT INTO `clt_user_currency_account` VALUES ('7', '11', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.00', '7.00', '1', '0');
INSERT INTO `clt_user_currency_account` VALUES ('8', '12', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.00', '7.00', '1', '0');
INSERT INTO `clt_user_currency_account` VALUES ('9', '13', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.00', '7.00', '1', '0');
INSERT INTO `clt_user_currency_account` VALUES ('10', '14', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.00', '7.00', '1', '0');
INSERT INTO `clt_user_currency_account` VALUES ('11', '15', '14.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.00', '7.00', '1', '0');
INSERT INTO `clt_user_currency_account` VALUES ('12', '16', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.00', '7.00', '1', '0');
INSERT INTO `clt_user_currency_account` VALUES ('13', '17', '100.0000', '0.0000', '10000.0000', '0.0000', '0.0000', '0.00', '7.00', '1', '0');

-- ----------------------------
-- Table structure for clt_user_currency_list
-- ----------------------------
DROP TABLE IF EXISTS `clt_user_currency_list`;
CREATE TABLE `clt_user_currency_list` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL DEFAULT '0' COMMENT '用户id',
  `currency_id` int(4) DEFAULT '0' COMMENT '对应币种列表id',
  `num` decimal(14,4) DEFAULT '0.0000' COMMENT '币种数量',
  `freeze_num` decimal(14,4) DEFAULT '0.0000' COMMENT '冻结数量',
  `lock_num` decimal(14,4) DEFAULT '0.0000' COMMENT '锁仓数量',
  `status` tinyint(2) DEFAULT '0' COMMENT '0锁仓，1锁仓',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_user_currency_list
-- ----------------------------
INSERT INTO `clt_user_currency_list` VALUES ('1', '1', '7', '8.0000', '0.0000', '0.0000', '0');
...
CREATE TABLE `clt_user_dynamic_amei_bonus` (
  ...
  `dynamic_bonus` decimal(10,4) NOT NULL DEFAULT '0.0000' COMMENT '动态奖金数量',
  `rate` decimal(5,2) DEFAULT '0.00' COMMENT '本次汇率',
  `ameibi_price` decimal(5,2) DEFAULT '0.00' COMMENT '阿美币价格',
  `ameibi_num` decimal(10,4) DEFAULT '0.0000' COMMENT '应发阿美币数量',
...
-- ----------------------------
-- Table structure for clt_user_dynamic_except
-- ----------------------------
DROP TABLE IF EXISTS `clt_user_dynamic_except`;
CREATE TABLE `clt_user_dynamic_except` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL DEFAULT '0' COMMENT '用户id',
  `from_id` int(10) DEFAULT '0' COMMENT '动态收益来自用户id',
  `dynamic_bonus` decimal(14,4) DEFAULT '0.0000' COMMENT '动态收益数量',
  `rate` decimal(8,2) DEFAULT '0.00' COMMENT '汇率',
  `time` int(10) DEFAULT '0' COMMENT '时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_user_dynamic_except
-- ----------------------------

-- ----------------------------
-- Table structure for clt_user_except_grant
-- ----------------------------
DROP TABLE IF EXISTS `clt_user_except_grant`;
CREATE TABLE `clt_user_except_grant` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL,
  `change_num` decimal(10,4) DEFAULT '0.0000' COMMENT '发放失败数量',
  `create_time` int(10) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_user_except_grant
-- ----------------------------
...
CREATE TABLE `clt_user_level` (
  ...
  `bonus_level` int(3) NOT NULL DEFAULT '0' COMMENT '会员等级领取接点奖金层数',
  `promotion_award` float(5,2) NOT NULL DEFAULT '0.05' COMMENT '推广奖励',
...
-- ----------------------------
INSERT INTO `clt_user_level` VALUES ('1', 'F', '1', '0', '500', '4', '0.05');
INSERT INTO `clt_user_level` VALUES ('2', 'F1', '2', '501', '1000', '6', '0.25');
INSERT INTO `clt_user_level` VALUES ('3', 'F2', '3', '1001', '2000', '8', '0.50');
INSERT INTO `clt_user_level` VALUES ('4', 'F3', '4', '2001', '3500', '10', '2.50');
INSERT INTO `clt_user_level` VALUES ('5', 'F4', '5', '3501', '5500', '12', '5.00');

-- ----------------------------
-- Table structure for clt_user_login_log
-- ----------------------------
DROP TABLE IF EXISTS `clt_user_login_log`;
CREATE TABLE `clt_user_login_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '状态，0失败，1成功',
  `user_id` int(10) NOT NULL DEFAULT '0' COMMENT '用户id',
  `login_method` varchar(30) DEFAULT '' COMMENT '登录方式',
  `status` tinyint(2) DEFAULT '1' COMMENT '登录状态，1成功，2失败',
  `ip` varchar(20) DEFAULT '' COMMENT '登录ip地址',
  `create_time` datetime DEFAULT '0000-00-00 00:00:00' COMMENT '登录时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=39 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_user_login_log
-- ----------------------------
INSERT INTO `clt_user_login_log` VALUES ('1', '1', '1', '1', '190.1.1.1', '2019-03-30 23:20:12');
INSERT INTO `clt_user_login_log` VALUES ('2', '1', 'WEB', '1', '127.0.0.1', '2019-03-30 23:38:52');
INSERT INTO `clt_user_login_log` VALUES ('3', '1', 'WEB', '1', '127.0.0.1', '2019-03-30 23:40:40');
INSERT INTO `clt_user_login_log` VALUES ('4', '1', 'WEB', '0', '127.0.0.1', '2019-03-31 10:29:45');
INSERT INTO `clt_user_login_log` VALUES ('5', '1', 'WEB', '0', '127.0.0.1', '2019-03-31 10:29:52');
INSERT INTO `clt_user_login_log` VALUES ('6', '1', 'WEB', '1', '127.0.0.1', '2019-03-31 10:29:57');
INSERT INTO `clt_user_login_log` VALUES ('7', '1', 'WEB', '1', '127.0.0.1', '2019-03-31 11:04:24');
INSERT INTO `clt_user_login_log` VALUES ('8', '1', 'WEB', '0', '127.0.0.1', '2019-03-31 23:22:05');
INSERT INTO `clt_user_login_log` VALUES ('9', '1', 'WEB', '1', '127.0.0.1', '2019-03-31 23:22:15');
INSERT INTO `clt_user_login_log` VALUES ('10', '1', 'WEB', '1', '127.0.0.1', '2019-04-01 13:22:30');
INSERT INTO `clt_user_login_log` VALUES ('11', '1', 'WEB', '1', '127.0.0.1', '2019-04-01 18:20:52');
INSERT INTO `clt_user_login_log` VALUES ('12', '1', 'WEB', '1', '127.0.0.1', '2019-04-01 18:25:04');
INSERT INTO `clt_user_login_log` VALUES ('13', '1', 'WEB', '1', '127.0.0.1', '2019-04-01 21:13:41');
INSERT INTO `clt_user_login_log` VALUES ('14', '1', 'WEB', '1', '127.0.0.1', '2019-04-02 09:03:47');
INSERT INTO `clt_user_login_log` VALUES ('15', '1', 'WEB', '1', '127.0.0.1', '2019-04-02 13:41:43');
INSERT INTO `clt_user_login_log` VALUES ('16', '1', 'WEB', '1', '127.0.0.1', '2019-04-02 21:20:19');
INSERT INTO `clt_user_login_log` VALUES ('17', '1', 'WEB', '1', '127.0.0.1', '2019-04-03 09:38:38');
INSERT INTO `clt_user_login_log` VALUES ('18', '1', 'WEB', '1', '127.0.0.1', '2019-04-03 22:54:23');
INSERT INTO `clt_user_login_log` VALUES ('19', '1', 'WEB', '1', '127.0.0.1', '2019-04-04 00:08:23');
INSERT INTO `clt_user_login_log` VALUES ('20', '1', 'WEB', '1', '127.0.0.1', '2019-04-04 00:23:33');
INSERT INTO `clt_user_login_log` VALUES ('21', '1', 'WEB', '1', '127.0.0.1', '2019-04-04 15:51:46');
INSERT INTO `clt_user_login_log` VALUES ('22', '1', 'WEB', '1', '127.0.0.1', '2019-04-04 16:09:36');
INSERT INTO `clt_user_login_log` VALUES ('23', '1', 'WEB', '1', '127.0.0.1', '2019-04-04 16:32:00');
INSERT INTO `clt_user_login_log` VALUES ('24', '1', 'WEB', '1', '127.0.0.1', '2019-04-04 23:08:24');
INSERT INTO `clt_user_login_log` VALUES ('25', '1', 'WEB', '1', '127.0.0.1', '2019-04-04 23:17:44');
INSERT INTO `clt_user_login_log` VALUES ('26', '1', 'WEB', '1', '127.0.0.1', '2019-04-06 12:23:02');
INSERT INTO `clt_user_login_log` VALUES ('27', '1', 'WEB', '1', '127.0.0.1', '2019-04-06 13:25:19');
INSERT INTO `clt_user_login_log` VALUES ('28', '18', 'WEB', '1', '127.0.0.1', '2019-04-06 13:46:55');
INSERT INTO `clt_user_login_log` VALUES ('29', '18', 'WEB', '1', '127.0.0.1', '2019-04-06 13:53:41');
INSERT INTO `clt_user_login_log` VALUES ('30', '1', 'WEB', '1', '127.0.0.1', '2019-04-06 14:48:21');
INSERT INTO `clt_user_login_log` VALUES ('31', '18', 'WEB', '1', '127.0.0.1', '2019-04-06 14:49:23');
INSERT INTO `clt_user_login_log` VALUES ('32', '1', 'WEB', '1', '127.0.0.1', '2019-04-07 17:16:33');
INSERT INTO `clt_user_login_log` VALUES ('33', '1', 'WEB', '1', '127.0.0.1', '2019-04-08 09:32:34');
INSERT INTO `clt_user_login_log` VALUES ('34', '1', 'WEB', '1', '127.0.0.1', '2019-04-13 00:49:31');
INSERT INTO `clt_user_login_log` VALUES ('35', '1', 'WEB', '1', '127.0.0.1', '2019-04-13 19:53:05');
INSERT INTO `clt_user_login_log` VALUES ('36', '1', 'WEB', '1', '127.0.0.1', '2019-04-13 20:07:43');
INSERT INTO `clt_user_login_log` VALUES ('37', '1', 'WEB', '0', '127.0.0.1', '2019-04-13 20:13:51');
INSERT INTO `clt_user_login_log` VALUES ('38', '1', 'WEB', '1', '127.0.0.1', '2019-04-13 20:14:05');
...
-- ----------------------------
INSERT INTO `clt_user_message` VALUES ('1', '1', '0', '1111', '1111', '1', '1', '2019-04-04 16:16:13');
INSERT INTO `clt_user_message` VALUES ('2', '0', '1', '你的信息', 'you message', '1', '1', '2019-04-05 22:43:37');

-- ----------------------------
-- Table structure for clt_user_message_reply
-- ----------------------------
DROP TABLE IF EXISTS `clt_user_message_reply`;
CREATE TABLE `clt_user_message_reply` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `message_id` int(10) DEFAULT '0' COMMENT 'user_message表id',
  `content` varchar(500) DEFAULT '' COMMENT '回复信息',
  `from_id` int(10) DEFAULT '0' COMMENT '发送人id',
  `to_id` int(10) DEFAULT '0' COMMENT '接收人id',
  `create_time` datetime DEFAULT '0000-00-00 00:00:00',
  `is_read` tinyint(2) DEFAULT '0' COMMENT '是否已读，0未读，1已读',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_user_message_reply
-- ----------------------------
INSERT INTO `clt_user_message_reply` VALUES ('1', '1', '111', '1', '0', '2019-04-05 21:41:41', '0');
INSERT INTO `clt_user_message_reply` VALUES ('2', '1', '222', '1', '0', '2019-04-05 21:48:19', '0');
INSERT INTO `clt_user_message_reply` VALUES ('3', '2', '111', '0', '0', '2019-04-05 23:07:55', '0');
INSERT INTO `clt_user_message_reply` VALUES ('4', '1', '11111', '0', '1', '2019-04-05 23:17:34', '0');
INSERT INTO `clt_user_message_reply` VALUES ('5', '2', '3333', '1', '0', '2019-04-05 23:19:06', '0');
INSERT INTO `clt_user_message_reply` VALUES ('6', '1', '3333333', '0', '1', '2019-04-05 23:44:16', '0');

-- ----------------------------
-- Table structure for clt_user_node
-- ----------------------------
DROP TABLE IF EXISTS `clt_user_node`;
CREATE TABLE `clt_user_node` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL DEFAULT '0' COMMENT '用户id',
  `user_son_str` varchar(5000) NOT NULL DEFAULT '' COMMENT '接点图id拼接',
  `enabled` tinyint(3) DEFAULT '0' COMMENT '0无效，1有效',
  `deep` int(5) DEFAULT '0' COMMENT '层数',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_user_node
-- ----------------------------
INSERT INTO `clt_user_node` VALUES ('7', '14', '1,', '0', '0');
INSERT INTO `clt_user_node` VALUES ('8', '15', '1,', '0', '0');
INSERT INTO `clt_user_node` VALUES ('9', '16', '1,15,', '0', '0');
INSERT INTO `clt_user_node` VALUES ('10', '17', '1,15,', '0', '0');

-- ----------------------------
-- Table structure for clt_user_referee
-- ----------------------------
DROP TABLE IF EXISTS `clt_user_referee`;
CREATE TABLE `clt_user_referee` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL DEFAULT '0' COMMENT '用户表id',
  `user_son_str` varchar(5000) NOT NULL DEFAULT '' COMMENT '直推图id连接',
  `enabled` tinyint(2) DEFAULT '0' COMMENT '是否生效，1有效，0无效',
  `deep` int(5) DEFAULT '0' COMMENT '层数',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_user_referee
-- ----------------------------
INSERT INTO `clt_user_referee` VALUES ('7', '14', '1,', '0', '0');
INSERT INTO `clt_user_referee` VALUES ('8', '15', '1,', '0', '0');
INSERT INTO `clt_user_referee` VALUES ('9', '16', '1,15,', '0', '0');
INSERT INTO `clt_user_referee` VALUES ('10', '17', '1,15,', '0', '0');

-- ----------------------------
-- Table structure for clt_user_running_log
-- ----------------------------
DROP TABLE IF EXISTS `clt_user_running_log`;
CREATE TABLE `clt_user_running_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL DEFAULT '0' COMMENT '用户id',
  `about_id` int(10) NOT NULL DEFAULT '0' COMMENT '相关用户',
  `running_type` smallint(4) NOT NULL DEFAULT '0' COMMENT '流水类型，1后台充值，2后台扣除，3申请充值，4提现拒绝返还，5提现扣除，6转账增加，7转账扣除，8转换增加，9转换扣除，10在线充值，11购物扣除，12取消订单返还，13报单扣除，14重消，15扣税，16复投，17提成，18静态收益，19直推奖，20动态奖，21报单中心奖，22激活成功本金增加，23动态奖转换阿美币，24转换手续费，25现金币转换阿美币，26提现手续费，27提现扣除给油卡，28交易增加，29交易扣除，30交易手续费，31撤销挂单，32挂单扣除，33撤回复投，34，撤回复投手续费，35锁仓扣除，36截仓扣除',
  `account_type` smallint(3) NOT NULL DEFAULT '0' COMMENT '对应currency表id',
  `change_num` decimal(14,4) NOT NULL DEFAULT '0.0000' COMMENT '变更数量',
  `balance` decimal(14,4) NOT NULL DEFAULT '0.0000' COMMENT '余额',
  `create_time` int(11) NOT NULL DEFAULT '0' COMMENT '流水时间',
  `remark` varchar(500) DEFAULT '' COMMENT '备注',
  `order_id` int(10) DEFAULT '0' COMMENT '提现订单id',
  `status` tinyint(2) DEFAULT '1' COMMENT '提现时1显示，0未审核不显示',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=45 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_user_running_log
-- ----------------------------
INSERT INTO `clt_user_running_log` VALUES ('44', '1', '1', '25', '1', '-10.0000', '574.0000', '1554648904', '', '0', '1');
INSERT INTO `clt_user_running_log` VALUES ('43', '17', '17', '21', '1', '100.0000', '100.0000', '1554638283', '报单中心奖励', '0', '1');
INSERT INTO `clt_user_running_log` VALUES ('42', '1', '1', '25', '1', '-10.0000', '584.0000', '1554628798', '', '0', '1');
INSERT INTO `clt_user_running_log` VALUES ('41', '1', '1', '25', '1', '-10.0000', '594.0000', '1554628610', '', '0', '1');
INSERT INTO `clt_user_running_log` VALUES ('40', '15', '17', '19', '1', '7.0000', '14.0000', '1554358956', '', '0', '1');
INSERT INTO `clt_user_running_log` VALUES ('37', '1', '15', '19', '1', '300.0000', '304.0000', '1554357231', '', '0', '1');
INSERT INTO `clt_user_running_log` VALUES ('38', '1', '14', '19', '1', '300.0000', '604.0000', '1554357240', '', '0', '1');
INSERT INTO `clt_user_running_log` VALUES ('39', '15', '16', '19', '1', '7.0000', '7.0000', '1554357645', '', '0', '1');

-- ----------------------------
-- Table structure for clt_user_trade_depute
-- ----------------------------
DROP TABLE IF EXISTS `clt_user_trade_depute`;
CREATE TABLE `clt_user_trade_depute` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL DEFAULT '0' COMMENT '用户id',
  `depute_type` tinyint(2) NOT NULL DEFAULT '0' COMMENT '委托类型，1买入，2卖出',
  `status` tinyint(3) DEFAULT '0' COMMENT '成交状态，1未成交，2部分成交，3完成成交，4撤单处理中，5已撤销',
  `depute_currency` int(4) DEFAULT '0' COMMENT '委托币种',
  `trade_currency` int(4) DEFAULT '0' COMMENT '交易币种',
  `trade_method` tinyint(3) DEFAULT '1' COMMENT '交易方式，1银行卡，2支付宝，3微信',
  `num` decimal(14,4) DEFAULT '0.0000' COMMENT '交易数量',
  `price` decimal(14,4) DEFAULT '0.0000' COMMENT '单价',
  `sum` decimal(14,4) DEFAULT '0.0000' COMMENT '委托总额',
  `poundage` decimal(14,4) DEFAULT '0.0000' COMMENT '手续费',
  `real_sum` decimal(14,4) DEFAULT '0.0000' COMMENT '真实总额',
  `have_trade` decimal(14,4) DEFAULT '0.0000' COMMENT '已成交',
  `create_time` int(10) DEFAULT '0' COMMENT '时间戳',
  `depute_status` tinyint(2) DEFAULT '0' COMMENT '1正在委托，2历史委托',
  `depute_time` int(10) DEFAULT '0' COMMENT '成交时间',
  `lock` tinyint(2) DEFAULT '0' COMMENT '0可交易，1交易锁定',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=30 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_user_trade_depute
-- ----------------------------
INSERT INTO `clt_user_trade_depute` VALUES ('1', '1', '1', '1', '7', '1', '1', '500.0000', '1.9780', '978.0000', '0.0000', '0.0000', '0.0000', '1554019986', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('2', '1', '1', '2', '7', '1', '1', '600.0000', '2.0000', '1200.0000', '0.0000', '0.0000', '0.0000', '1554019986', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('3', '1', '2', '2', '3', '1', '1', '1000.0000', '3.0000', '200.0000', '0.0000', '0.0000', '0.0000', '1554019968', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('4', '1', '2', '2', '3', '1', '1', '333.0000', '4.0000', '400.0000', '0.0000', '0.0000', '0.0000', '1554019999', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('5', '1', '1', '1', '1', '1', '1', '300.0000', '2.0000', '600.0000', '0.6000', '599.4000', '0.0000', '1554259572', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('6', '1', '1', '1', '1', '1', '1', '300.0000', '2.0000', '600.0000', '0.6000', '599.4000', '0.0000', '1554260927', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('7', '1', '1', '1', '1', '1', '1', '200.0000', '2.0000', '400.0000', '0.4000', '399.6000', '0.0000', '1554274419', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('8', '1', '1', '1', '1', '1', '1', '2.0000', '11.0000', '22.0000', '0.0220', '21.9780', '0.0000', '1554639002', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('9', '1', '1', '1', '1', '1', '1', '33.0000', '2.0000', '66.0000', '0.0660', '65.9340', '0.0000', '1554639067', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('10', '1', '1', '1', '1', '1', '1', '30.0000', '2.0000', '60.0000', '0.0600', '59.9400', '0.0000', '1554652342', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('11', '1', '1', '1', '1', '1', '1', '22.0000', '1.0000', '22.0000', '0.0220', '21.9780', '0.0000', '1554652519', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('12', '1', '2', '1', '1', '1', '1', '3.0000', '2.0000', '6.0000', '0.0060', '5.9940', '0.0000', '1554652755', '2', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('13', '1', '1', '1', '1', '1', '1', '30.0000', '4.0000', '120.0000', '0.1200', '119.8800', '0.0000', '1554652790', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('14', '1', '2', '1', '1', '1', '1', '2.0000', '2.0000', '4.0000', '0.0040', '3.9960', '0.0000', '1554653033', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('15', '1', '2', '1', '1', '1', '1', '5.0000', '2.0000', '10.0000', '0.0100', '9.9900', '0.0000', '1554653221', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('16', '1', '1', '1', '1', '1', '1', '12.0000', '2.0000', '24.0000', '0.0240', '23.9760', '0.0000', '1555160340', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('17', '1', '1', '1', '1', '1', '1', '13.0000', '2.0000', '26.0000', '0.0260', '25.9740', '0.0000', '1555160346', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('18', '1', '1', '1', '1', '1', '1', '11.0000', '3.0000', '33.0000', '0.0330', '32.9670', '0.0000', '1555160352', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('19', '1', '1', '1', '1', '1', '1', '14.0000', '2.0000', '28.0000', '0.0280', '27.9720', '0.0000', '1555160361', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('20', '1', '1', '1', '1', '1', '1', '15.0000', '2.0000', '30.0000', '0.0300', '29.9700', '0.0000', '1555160369', '2', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('21', '1', '2', '1', '1', '1', '1', '8.0000', '2.0000', '16.0000', '0.0160', '15.9840', '0.0000', '1555162962', '2', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('22', '1', '2', '1', '1', '1', '1', '10.0000', '2.0000', '20.0000', '0.0200', '19.9800', '0.0000', '1555163282', '2', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('23', '1', '2', '1', '1', '1', '1', '11.0000', '2.0000', '22.0000', '0.0220', '21.9780', '0.0000', '1555163288', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('24', '1', '2', '1', '1', '1', '1', '12.0000', '2.0000', '24.0000', '0.0240', '23.9760', '0.0000', '1555163296', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('25', '1', '2', '1', '1', '1', '1', '2.0000', '3.0000', '6.0000', '0.0060', '5.9940', '0.0000', '1555163307', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('26', '1', '2', '1', '1', '1', '1', '11.0000', '2.0000', '22.0000', '0.0220', '21.9780', '0.0000', '1555163313', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('27', '1', '2', '1', '1', '1', '1', '1.0000', '2.0000', '2.0000', '0.0020', '1.9980', '0.0000', '1555163318', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('28', '1', '2', '3', '1', '1', '1', '2.0000', '2.0000', '4.0000', '0.0040', '3.9960', '0.0000', '1555163323', '1', '0', '0');
INSERT INTO `clt_user_trade_depute` VALUES ('29', '1', '1', '1', '1', '1', '1', '5.0000', '2.0000', '10.0000', '0.0100', '9.9900', '0.0000', '1555167941', '1', '0', '0');

-- ----------------------------
-- Table structure for clt_user_trade_depute_log
-- ----------------------------
DROP TABLE IF EXISTS `clt_user_trade_depute_log`;
CREATE TABLE `clt_user_trade_depute_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `users_id` int(10) DEFAULT '0' COMMENT '订单用户id',
  `user_id` int(10) NOT NULL DEFAULT '0' COMMENT '用户id',
  `order_num` varchar(20) NOT NULL DEFAULT '' COMMENT '订单号',
  `trade_num` decimal(10,2) DEFAULT '0.00' COMMENT '本次交易数量',
  `trade_currency` int(4) DEFAULT '0' COMMENT '币种id',
  `price` decimal(10,2) DEFAULT '0.00' COMMENT '成交价格',
  `poundage` decimal(14,4) DEFAULT '0.0000' COMMENT '手续费',
  `sum` decimal(14,4) DEFAULT '0.0000' COMMENT '总价',
  `trade_depute_id` int(10) DEFAULT '0' COMMENT '对应托管id',
  `create_time` int(11) DEFAULT '0',
  `trade_type` tinyint(2) DEFAULT '0' COMMENT '1买入，2卖出',
  `about_id` int(10) DEFAULT '0' COMMENT '相关人',
  `trade_status` tinyint(2) DEFAULT '0' COMMENT '成交状态，1待付款，2确定付款，3完成成交，4取消',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_user_trade_depute_log
-- ----------------------------
INSERT INTO `clt_user_trade_depute_log` VALUES ('1', '1', '1', 'JF454151515555', '200.00', null, '2.00', '0.0000', '0.0000', '2', '1559808988', '1', '24', '1');

-- ----------------------------
-- Table structure for clt_user_trade_log
-- ----------------------------
DROP TABLE IF EXISTS `clt_user_trade_log`;
CREATE TABLE `clt_user_trade_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL,
  `trade_num` decimal(14,4) DEFAULT '0.0000' COMMENT '交易数量',
  `trade_sum` decimal(14,4) DEFAULT '0.0000' COMMENT '交易金额',
  `create_time` datetime DEFAULT '0000-00-00 00:00:00' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of clt_user_trade_log
-- ----------------------------
...
INSERT INTO `clt_wx_menu` VALUES ('2', '0', '手册', '', '0', '2', '0', 'http://www.cltphp.com/', '0', '2', '1512442543', '0');
INSERT INTO `clt_wx_menu` VALUES ('3', '0', '论坛', '', '0', '1', '4', 'http://bbs.cltphp.com/', '0', '3', '1512547727', '0');
INSERT INTO `clt_wx_menu` VALUES ('4', '0', '子菜单名称', '', '3', '1', '0', '', '0', '1', '1542953435', '0');
INSERT INTO `clt_wx_menu` VALUES ('5', '0', '子菜单名称', '', '2', '1', '0', '', '0', '1', '1542954138', '0');
