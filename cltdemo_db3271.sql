...
CREATE TABLE `clt_user_currency_account` (
  ...
  `transaction_num每日一皮` decimal(10,4) DEFAULT '0.0000' COMMENT '交易钱包余额',
...
-- ----------------------------
INSERT INTO `clt_user_level` VALUES ('1', '注册会员', '1', '0', '500', '4', '0.05', 'F');
INSERT INTO `clt_user_level` VALUES ('2', '铜牌会员', '2', '501', '1000', '6', '0.25', 'F1');
