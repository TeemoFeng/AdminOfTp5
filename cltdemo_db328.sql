...
INSERT INTO `clt_auth_rule` VALUES ('7', 'Category', '栏目管理', '1', '1', '0', 'icon-list', '', '0', '50', '1446535875', '1', '0');
...
CREATE TABLE `clt_user_currency_account` (
  ...
  `cash_currency_num` decimal(10,4) NOT NULL DEFAULT '0.0000' COMMENT '现金币数量（即产生的收益沙特链）',
  `cash_input_num` decimal(10,4) NOT NULL DEFAULT '0.0000' COMMENT '复投数量',
  `corpus` decimal(10,4) DEFAULT '0.0000' COMMENT '用户本金账户余额',
  `activation_num` decimal(10,4) DEFAULT '0.0000' COMMENT '激活钱包余额',
  `consume_num` decimal(10,4) DEFAULT '0.0000' COMMENT '消费钱包余额',
  `transaction_num` decimal(10,4) DEFAULT '0.0000' COMMENT '交易钱包余额',
...
CREATE TABLE `clt_user_running_log` (
  ...
  `change_num` decimal(10,4) NOT NULL DEFAULT '0.0000' COMMENT '变更数量',
